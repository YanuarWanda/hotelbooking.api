...
public class EditUserTests
{
	...
	{
		var fakeReadRepositoryBuilder = new RoleServiceBuilder().GetByIdAllParams();
	...
	public async Task EditUserShouldReturnBadRequestWhenValidationIsFalse(string note, EditUserRequest request)
	{
		...
		var handler = new EditUser(fakeReadRepository.Object, fakeUserService.Object, fakeApplicationDbContext.Object,
	...
	public async Task EditUserShouldReturnNotFound()
	{
		...
		var fakeRoleReadRepo = fakeRoleReadRepoBuilder.Build();
		...
		var handler = new EditUser(fakeRoleReadRepo.Object, fakeUserService.Object, fakeApplicationDbContext.Object,
			fakeCurrentUserService.Object);
	...
	public async Task EditUserCorrectFlowAppendOneRole()
	{
		...
		//added role
		fakeRoleReadRepoBuilder.GetByIdAsync(newRoleId,
