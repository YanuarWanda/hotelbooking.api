...
using hotelbooking.api.WebApi.EndPoints.Users;
using Xunit;

namespace hotelbooking.api.UnitTests.Endpoints.Users;
...
public class LoginTests
{
    ...
    [Theory]
    [InlineData("vendy@hotelbooking.api.com", "Qwerty@123")]
    [InlineData("dev@hotelbooking.api.com", " @123aax")]
